...
#define ledVerde 22 //este led sinaliza que o ESP foi conectado
#define ledVermelho 13 //este led é usado como exemplo de atualização

ESP8266WiFiMulti wifiMulti;

const char* ssid = "IGENIAL"; //nome da rede
const char* password = "10261026"; //senha da rede
